...
#define SD_DMA_RX_STREAM  DMA1_Stream0
#define SD_DMA_RX_TCIF    DMA_FLAG_TCIF0

#define SD_DMA_TX_CHANNEL DMA_Channel_0
#define SD_DMA_TX_STREAM  DMA1_Stream5
#define SD_DMA_TX_TCIF    DMA_FLAG_TCIF5

#define SD_SCK_PIN        GPIO_Pin_10
#define SD_SCK_GPIO       GPIOC
#define SD_SCK_RCC        RCC_AHB1Periph_GPIOC
#define SD_SCK_SOURCE     GPIO_PinSource10
#define SD_SCK_AF         GPIO_AF_SPI3

#define SD_MISO_PIN       GPIO_Pin_4
#define SD_MISO_GPIO      GPIOB
#define SD_MISO_RCC       RCC_AHB1Periph_GPIOB
#define SD_MISO_SOURCE    GPIO_PinSource4
#define SD_MISO_AF        GPIO_AF_SPI3

#define SD_MOSI_PIN       GPIO_Pin_5
#define SD_MOSI_GPIO      GPIOB
#define SD_MOSI_RCC       RCC_AHB1Periph_GPIOB
#define SD_MOSI_SOURCE    GPIO_PinSource5
#define SD_MOSI_AF        GPIO_AF_SPI3

#define SD_CS_PIN         GPIO_Pin_15
#define SD_CS_GPIO        GPIOA
#define SD_CS_RCC         RCC_AHB1Periph_GPIOA


#define SD_CS_LOW()     GPIO_WriteBit(SD_CS_GPIO, SD_CS_PIN, Bit_RESET)
#define SD_CS_HIGH()	GPIO_WriteBit(SD_CS_GPIO, SD_CS_PIN, Bit_SET)
